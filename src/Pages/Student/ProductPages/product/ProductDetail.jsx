    ...
    return (
        <>
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="grid grid-cols-1 gap-8 md:grid-cols-2 p-8">
                    <div className="flex space-x-4">
                        ...
                        <div className="flex-1">
                            <img src={mainImage} alt="Main Display" className="w-full h-[400px] object-cover border border-gray-300" />
                        </div>
                    </div>

                    <div>
                        <h1 className="text-2xl font-semibold mb-3">Girls Uniform Set with blazer</h1>
                        <p className="text-gray-600 mb-2">Gurukul High School, Ahmedabad</p>
                        <hr />
                        <p className="text-sm text-gray-500 mt-2">
                            This set includes a blazer, skirt, white shirt and school brand
                        </p>

                        <div className="text-2xl font-bold mt-2 mb-2">₹ 700</div>
                        ...
                        <div className="mt-6">
                            <div className="border-b">
                                ...
                                >
                                    ...
                                    <span
                                        className={`rounded-full border border-blue-500 p-1 inline-flex items-center justify-center transition-transform duration-300 ${openAccordion === 'details' ? 'rotate-180' : ''}`}
                                    >
                                        <i className="fa-solid fa-chevron-down text-blue-700"></i>
                                    </span>
                                </button>
                                <div
                                    className={`overflow-hidden transition-all duration-1000 ease-in-out ${openAccordion === 'details' ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}
                                >
                            ...
                            <div className="border-b mt-2">
                                ...
                                >
                                    ...
                                    <span
                                        className={`rounded-full border border-blue-500 p-1 inline-flex items-center justify-center transition-transform duration-300 ${openAccordion === 'seller' ? 'rotate-180' : ''}`}
                                    >
                                        <i className="fa-solid fa-chevron-down text-blue-700"></i>
                                    </span>
                                </button>
                                <div
                                    className={`overflow-hidden transition-all duration-1000 ease-in-out ${openAccordion === 'seller' ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}
                                >
                                    <div className="pb-3 bg-white">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis temporibus doloribus neque nostrum recusandae dolores veniam reiciendis libero voluptatem debitis odit aliquam culpa pariatur distinctio tempora, reprehenderit ratione! Natus, aspernatur obcaecati. Voluptatibus, blanditiis veritatis vitae quibusdam adipisci perspiciatis laboriosam cupiditate architecto repellat ab porro.
                                    </div>
                                </div>
                            </div>
                        </div>
