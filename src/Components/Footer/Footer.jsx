...
const Footer = () => {
  ...
  return (
    <footer className="bg-grey-custom text-white py-8 sm:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-30 flex flex-col md:flex-row justify-between items-start gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3 mt-5">
            <li
              className="text-base sm:text-lg hover:text-yellow-400 cursor-pointer transition duration-300"
        ...
        <div>
          ...
          <p className="text-base sm:text-lg mt-4">
            Phone:{" "}
            <a href="tel:+91844644464" className="hover:text-yellow-400 transition duration-300">
              +91 844644464
            </a>
          </p>
          <p className="text-base sm:text-lg mt-4">
            Email:{" "}
            <a href="mailto:info@netfotech.in" className="hover:text-yellow-400 transition duration-300">
              info@netfotech.in
            </a>
          </p>
        </div>
